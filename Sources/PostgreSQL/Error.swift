...
// A list of all Error messages that can be thrown from calls to `Database`.
// All Error objects contain a String which contains PostgreSQL's last error message.
...
extension PostgreSQLError {
    public enum Code: String {
        ...
        // case string_data_right_truncation = "22001" // already declared above
        ...
        // case modifying_sql_data_not_permitted = "38002" // already declared above
        // case prohibited_sql_statement_attempted = "38003" // already declared above
        // case reading_sql_data_not_permitted = "38004" // already declared above
        case external_routine_invocation_exception = "39000"
        case invalid_sqlstate_returned = "39001"
        // case null_value_not_allowed = "39004" // already declared above
...
extension PostgreSQLError {
    public init(_ connection: Connection) {
        let raw = PQerrorMessage(connection.cConnection)
...
extension PostgreSQLError: Debuggable {
    ...
    public var documentationLinks: [String] {
        return [
            "https://www.postgresql.org/docs/current/static/errcodes-appendix.htmlhtml",
        ]
    }
}
